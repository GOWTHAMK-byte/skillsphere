...
class CreatePostForm(FlaskForm):
    ...
    team_size = IntegerField('Team Size', validators=[Optional(), NumberRange(min=1, max=100)])
    team_requirement = StringField('Team Requirements (e.g., gender, experience level)', validators=[Optional()])
    ...
    gender_requirement = SelectField('Gender Requirement', choices=[('Any', 'Any'), ('Male', 'Male'), ('Female', 'Female'), ('Other', 'Other')], validators=[Optional()])
